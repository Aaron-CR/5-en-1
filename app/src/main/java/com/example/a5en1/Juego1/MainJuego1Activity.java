...
public class MainJuego1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (categoria == 1) {
            ...
            CATEGORIA.add("ALGEBRA");
            CATEGORIA.add("NAVIDAD");
            CATEGORIA.add("REGIMEN");
            CATEGORIA.add("BRUJULA");
            CATEGORIA.add("BROCOLI");
            CATEGORIA.add("CRONICA");
            CATEGORIA.add("CERROJO");
            CATEGORIA.add("DISPARO");
            CATEGORIA.add("DAMASCO");
            CATEGORIA.add("ECLIPSE");
            CATEGORIA.add("FLUIDEZ");
            CATEGORIA.add("GENERAL");
            CATEGORIA.add("LOGISTA");
            CATEGORIA.add("HOLANDA");
            CATEGORIA.add("PROFUGO");
            CATEGORIA.add("SUDESTE");
            CATEGORIA.add("ZUMBIDO");
            CATEGORIA.add("ZOCALOS");
            CATEGORIA.add("SEPTIMO");
            CATEGORIA.add("SEGUNDO");
            CATEGORIA.add("MIRADORES");
            CATEGORIA.add("DRENAJES");
            CATEGORIA.add("CONSERJE");
            CATEGORIA.add("CABALLERO");
            CATEGORIA.add("APRENDIZ");
            CATEGORIA.add("BEBEDERO");
            CATEGORIA.add("ACORDEON");
            CATEGORIA.add("GIGANTE");
            CATEGORIA.add("INTEGRANTE");
            CATEGORIA.add("INGENIERO");
        } else if (categoria == 3) {
            imageView.setVisibility(View.VISIBLE);
            imageView.setImageResource(R.drawable.ic_juego_1_dificil);
            vidas = 2;
            categoriaString = getString(R.string.category_dificil_juego1);
            CATEGORIA.add("INNOVADOR");
            CATEGORIA.add("NEPTUNO");
            CATEGORIA.add("ISOTOPO");
            CATEGORIA.add("SATISFACTORIO");
            CATEGORIA.add("INTERNACIONAL");
            CATEGORIA.add("GRATIFICANTE");
            CATEGORIA.add("LINEAMIENTO");
            CATEGORIA.add("AGRADECIDO");
            CATEGORIA.add("LANZAMIENTO");
            CATEGORIA.add("VELOCIMETRO");
            CATEGORIA.add("ESTACIONAMIENTO");
            CATEGORIA.add("ENTRETENIMIENTO");
            CATEGORIA.add("ANTAGONISTA");
            CATEGORIA.add("ALMOHADA");
            CATEGORIA.add("BARBACOA");
            CATEGORIA.add("COMPARSA");
            CATEGORIA.add("CABALLERIA");
            CATEGORIA.add("CREATIVIDAD");
            CATEGORIA.add("CATASTROFE");
            CATEGORIA.add("DEMOCRACIA");
            CATEGORIA.add("DOMINACION");
            CATEGORIA.add("EFERVESCENCIA");
            CATEGORIA.add("ELECTRICIDAD");
            CATEGORIA.add("FALSIFICACION");
            CATEGORIA.add("FELICITACION");
            CATEGORIA.add("GENDARMERIA");
            CATEGORIA.add("GESTICULACION");
            CATEGORIA.add("IDENTIFICACION");
            CATEGORIA.add("IMPORTANCIA");
            CATEGORIA.add("MADRIGUERA");
            CATEGORIA.add("NACIONALIDAD");
            CATEGORIA.add("OBSERVACION");
            CATEGORIA.add("ONOMATOPEYA");
            CATEGORIA.add("QUEMADURA");
            CATEGORIA.add("RESPUESTA");
        } else if (categoria == 4) {
            imageView.setVisibility(View.VISIBLE);
