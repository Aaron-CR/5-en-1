...
public class Juego4Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_2);
        ...
        rb1= (RadioButton)findViewById(R.id.rb_2a);
        rb2= (RadioButton)findViewById(R.id.rb_2b);
        contadores= (TextView) findViewById(R.id.txt_cont2);
    ...
    public void siguiente(View view) {
        ...
        if (rb1.isChecked() == true) {
            tiempo--; facultad--;
            Toast.makeText(this, "-tiempo, -facultad", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, Juego4Activity3_1.class);
            ...
            Intent i = new Intent(this, Juego4Activity3_2.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
            i.putExtra("social", social);
