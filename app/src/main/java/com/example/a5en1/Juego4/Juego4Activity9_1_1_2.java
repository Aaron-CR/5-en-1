...
public class Juego4Activity9_1_1_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_9_1_1_2);
        ...
        rb1 = (RadioButton) findViewById(R.id.rb_9_1_1_2a);
        rb2 = (RadioButton) findViewById(R.id.rb_9_1_1_2b);
        rb3 = (RadioButton) findViewById(R.id.rb_9_1_1_2c);
        contadores = (TextView) findViewById(R.id.txt_cont9_1_1_2);
    ...
    public void siguiente(View view) {
        ...
        if (rb1.isChecked() == true) {
            ...
            Intent i = new Intent(this, Juego4Activity10_1_1_2.class);
            ...
            hambre++;
            Toast.makeText(this, "+hambre", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, Juego4Activity10_1_1_2.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
