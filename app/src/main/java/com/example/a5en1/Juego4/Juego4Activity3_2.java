...
public class Juego4Activity3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_3_2);
        ...
        contadores= (TextView) findViewById(R.id.txt_cont3_2);
    ...
    public void vamos(View view) {
        ...
        plata--; hambre++;
        Toast.makeText(this, "-plata, +hambre", Toast.LENGTH_SHORT).show();
