...
public class Juego4Activity9_1_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_9_1_1_1);
        ...
        rb1 = (RadioButton) findViewById(R.id.rb_9_1_1_1a);
        rb2 = (RadioButton) findViewById(R.id.rb_9_1_1_1b);
        contadores = (TextView) findViewById(R.id.txt_cont9_1_1_1);
    ...
    public void siguiente(View view) {
        ...
        if (rb1.isChecked() == true) {
            ...
            Intent i = new Intent(this, Juego4Activity10_1_1_1_2.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
            i.putExtra("social", social);
