...
public class Juego4Activity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_1);
        ...
        rb1= (RadioButton)findViewById(R.id.rb_1a);
        rb2= (RadioButton)findViewById(R.id.rb_1b);
        rb3= (RadioButton)findViewById(R.id.rb_1c);
        contadores= (TextView) findViewById(R.id.txt_cont1);
    ...
    public void siguiente(View view){
        ...
        if(rb1.isChecked()== true){
            plata--; hambre+=2; sueño--;
            Toast.makeText(this, "-plata, ++hambre, -sueño", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, Juego4Activity2.class);
            ...
            hambre++; salud--;
            Toast.makeText(this, "+hambre, -salud", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, Juego4Activity2.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
            ...
            hambre--; sueño++; tiempo--;
            Toast.makeText(this, "-hambre, +sueño", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, Juego4Activity2.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
