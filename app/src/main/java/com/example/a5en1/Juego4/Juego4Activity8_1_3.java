...
public class Juego4Activity8_1_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_8_1_3);
        ...
        contadores = (TextView) findViewById(R.id.txt_cont8_1_3);
