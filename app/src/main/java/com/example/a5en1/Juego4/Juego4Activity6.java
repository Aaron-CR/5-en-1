...
public class Juego4Activity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_6);
        ...
        rb1 = (RadioButton) findViewById(R.id.rb_6a);
        rb2 = (RadioButton) findViewById(R.id.rb_6b);
        rb3 = (RadioButton) findViewById(R.id.rb_6c);
        contadores = (TextView) findViewById(R.id.txt_cont6);
    ...
    public void siguiente(View view) {
        ...
        if (rb1.isChecked() == true) {
            Intent i = new Intent(this, Juego4Activity7_1.class);
            ...
            Intent i = new Intent(this, Juego4Activity7_2.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
            i.putExtra("social", social);
            ...
            Intent i = new Intent(this, Juego4Activity7_3.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
            i.putExtra("social", social);
