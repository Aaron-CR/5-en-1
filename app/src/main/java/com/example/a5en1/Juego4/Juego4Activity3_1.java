...
public class Juego4Activity3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_3_1);
        ...
        rb1 = (RadioButton) findViewById(R.id.rb_3_1a);
        rb2 = (RadioButton) findViewById(R.id.rb_3_1b);
        contadores = (TextView) findViewById(R.id.txt_cont3_1);
    ...
    public void siguiente(View view) {
        ...
        if (rb1.isChecked() == true) {
            Intent i = new Intent(this, Juego4Activity4_1_1.class);
            ...
            Intent i = new Intent(this, Juego4Activity4_1_2.class);
            i.putExtra("plata", plata);
            i.putExtra("hambre", hambre);
            i.putExtra("diversion", diversion);
            i.putExtra("social", social);
