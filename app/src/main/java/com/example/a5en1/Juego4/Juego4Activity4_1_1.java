...
public class Juego4Activity4_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_4_1_1);
        ...
        contadores= (TextView) findViewById(R.id.txt_cont4_1_1);
    ...
    public void siguiente(View view) {
        ...
        plata += 2; diversion++; facultad--; tiempo--;
        Toast.makeText(this, "++plata, +diversión,\n-facultad, -tiempo", Toast.LENGTH_LONG).show();

        Intent i = new Intent(this, Juego4Activity5_1_1.class);
