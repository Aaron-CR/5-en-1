...
public class Juego4Activity5_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_5_1_1);
        ...
        rb1 = (RadioButton) findViewById(R.id.rb_5_1_1a);
        rb2 = (RadioButton) findViewById(R.id.rb_5_1_1b);
        contadores = (TextView) findViewById(R.id.txt_cont5_1_1);
