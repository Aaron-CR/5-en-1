...
public class Juego4Activity9_1_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_4_9_1_2_1);
        ...
        contadores = (TextView) findViewById(R.id.txt_cont9_1_2_1);
